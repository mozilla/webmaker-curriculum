...
<img src="https://badgekit-mozilla.mofoprod.net/images/badge/945" alt="Composing for the Web badge" width="150px">
<img src="https://badgekit-mozilla.mofoprod.net/images/badge/946" alt="Remixing badge" width="150px">
<img src="https://badgekit-mozilla.mofoprod.net/images/badge/947" alt="Design and Accessibility badge" width="150px">

<ul>
<li><strong>Composing for the web:</strong> Creating and curating content for the web</li>
<li><strong>Remixing:</strong> Modifying existing web resources to create something new</li>
...
<ul>
<li>Remixing is a form of derivative artwork.</li>
<li>Media has influence over culture and society, and cultures and societies have influence over shaping media.</li>
<li>the Web is made out of building blocks that they can rearrange to create new things through an iterative process.</li>
</ul>
</ul>
